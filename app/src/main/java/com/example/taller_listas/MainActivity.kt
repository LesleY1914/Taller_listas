package com.example.taller_listas
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val todoList = remember {
                mutableStateListOf(
                    TodoItemData("Proceso 1", false),
                    TodoItemData("Proceso 2", false),
                    TodoItemData("Proceso 3", false)
                )
            }
